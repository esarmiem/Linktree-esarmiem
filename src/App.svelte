<header class="bg-orange-200 px-4 py-3 text-black">
  <p class="text-center text-sm font-medium">
    <a href="https://github.com/esarmiem" target="_blank">
      📲 Descubre mi perfil tecnológico y conoce los proyectos en los que
      estoy trabajando 🔗
    </a>
  </p>
</header>
...
<main class="flex-block max-w-xl p-4 md:pd-8 mx-auto mt-4">
  <section class="bg-white shadow overflow-hidden rounded-lg">
    <section class="px-4 py-5 sm:px-6 flex justify-between">
      <div>
        <h1 class="text-xl leading-6 font-bold text-gray-900">
          Elder Sarmiento Martinez 🇨🇴
        </h1>
        <h2 class="text-sm leading-6 text-gray-500 -mt-1">@esarmiem</h2>
        <p class="mt-1 pr-12 max-w-2xl text-sm text-gray-500">
    ...
    <section class="border-t border-gray-200">
      <div
        class="bg-white px-4 py-5 w-full flex justify-center space-x-0.5"
      >
      ...
      <section class="bg-orange-200 px-5 py-5 w-full flex justify-between">
        <a
          class="text-sm font-bold text-gray-700 text-center hover:text-yellow-800 hover:underline cursor-pointer"
...
<footer class="flex-block max-w-xl p-4 md:pd-8 mx-auto text-center">
  hecho con amor ❤️ esarmiem © 2023
</footer>